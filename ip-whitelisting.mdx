...
<Steps>
  ...
  <Step title="Configure in the Dashboard" icon="settings" titleType="h3">
    Log in to the [Deepvue Dashboard](https://dashboard.deepvue.tech) and navigate to the security settings. Add your server IP addresses to the whitelist.
  </Step>
...
|----------|--------|-------|
| **Trial** | `free_tier` | Testing and development with limited credits |
| **Live** | `live` + org ID | Production use with full access |
